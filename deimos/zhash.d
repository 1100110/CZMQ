...
alias int function(char* key, void* item, void* argument) zhash_foreach_fn;
...
int zhash_insert(zhash_t* self, char* key, void* item);

///  Update item into hash table with specified key and item.
///  If key is already present, destroys old item and inserts new one.
///  Use free_fn method to ensure deallocator is properly called on item.
///  Returns 0 on success, >0 on error, and -1 when racing.
int zhash_update(zhash_t* self, char* key, void* item);

///  Remove an item specified by key from the hash table. If there was no such
///  item, this function does nothing.
void zhash_delete(zhash_t* self, char* key);

///  Return the item at the specified key, or null
void* zhash_lookup(zhash_t* self, char* key);

///  Reindexes an item from an old key to a new key. If there was no such
///  item, does nothing. Returns 0 if successful, else -1.
int zhash_rename(zhash_t* self, char* old_key, char* new_key);
...
void* zhash_freefn(zhash_t* self, char* key, zhash_free_fn *free_fn);
